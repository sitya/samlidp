...
if ($this->data['sppp'] !== false) {
    echo '<h3>'.htmlspecialchars($this->t('{consent:consent:consent_privacypolicy}')).' ';
 ...
 */
function local_present_attributes($t, $attributes, $nameParent)
{
    ...
    if (strlen($nameParent) > 0) {
        ...
        $str = '<table class="attributes table table-striped" '.$summary.'>';
    } else {
        $parentStr = '';
        $str = '<table id="table_with_attributes"  class="attributes table table-striped" '.$summary.'>';
    }
...
echo '<h3 id="attributeheader" class="m-t-xl">'.
    $this->t(
...
echo local_present_attributes($this, $attributes, '');
